        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <ScrollReveal>
            ...
            <p className="font-body text-base sm:text-lg text-white/80 max-w-2xl">
              Explore our diverse range of premium agricultural products sourced from across East Africa. Each category represents our commitment to quality and ethical sourcing.
            </p>
          </ScrollReveal>
        </div>
      </section>
            ...
            {categories.map((category) => (
              <StaggerItem key={category.slug}>
                <Link
                  ...
                  className="group block bg-white rounded-xl overflow-hidden shadow-card hover:shadow-lift transition-all duration-300"
                >
                  {/* Image */}
              ...
              <div className="relative z-10 px-6 sm:px-10 lg:px-16 py-10 sm:py-14 lg:py-16 flex flex-col lg:flex-row items-start lg:items-center gap-6 lg:gap-10">
                <div className="flex-1">
                  ...
                  <p className="font-body text-white/80 max-w-xl">
                    Leverage our sourcing expertise and infrastructure to build your own brand. We offer complete private label solutions — from product development and custom packaging to regulatory compliance and worldwide shipping.
                  </p>
                </div>
                <Link
                  to="/contact"
